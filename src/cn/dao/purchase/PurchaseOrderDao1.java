 ...
 *
 */
public class PurchaseOrderDao1 extends DBUtil {
	/**
	 * 新增进货单信息
	 * 
	 * @param pur
	...
	public static void main(String[] args) {
		// PurchaseOrderDao purd = new PurchaseOrderDao();
		// String a = "2017-8-13";
		// java.sql.Date b = java.sql.Date.valueOf(a);
		// PurchaseOrder pur = new PurchaseOrder(1,b,1.0,1,0, "");
		// purd.addPurchaseOrder(pur);
		// ad.addSupply(sup);
