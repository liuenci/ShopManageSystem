...
public class PurchaseOldSel extends JFrame {
	...
	public void addpanel() {
		...
		tfnumber = comMenth.createTextField("", 110, 140, 60, 25, "宋体", 14, Color.WHITE);
		...
		btnSure.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if (goodNum <= 0) {
						JOptionPane.showMessageDialog(null, "数量不能小于或等于零");
						tfnumber.setText("");
					...
					// 输入失败警告
					JOptionPane.showMessageDialog(null, "亲，请输入正确的数字哦！", "操作提示", JOptionPane.WARNING_MESSAGE);
					tfnumber.setText("");
				}
			}
		});
